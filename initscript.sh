...
## install the themes ( this line installs my setup)
sudo ./Install -n vimix -c dark -t beryl

#Download Background Image
curl 'https://www.pixel4k.com/small-memory-4k-60763.html'
